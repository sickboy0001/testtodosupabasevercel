    ...
    <div>
        ...
        {localStorageEmail ? (
          <div className='flex  '>
            ...
            <button onClick={handleLogout} className="shadow-sm border-1 px-2 rounded-lg bg-blue-200">Logout</button>
          </div>
        ) : (
          <div className='flex  '>
            <form action="">
              <input type="text" value={email} placeholder='mailaddress' onChange={(e)=> setEmail(e.target.value)}  className='rounded border-2  px-2 border-gray-300 '/>
              <input type="password" value={password} placeholder='password' onChange={(e)=> setPassword(e.target.value)} className='rounded border-2  px-2 border-gray-300'/>
            </form>
            <button onClick={handleLogin} className="shadow-sm border-1 px-2 mr-2 rounded-lg bg-blue-200">Login</button>
            <button onClick={handleSignIn} className="shadow-sm border-1 px-2 mr-2 rounded-lg bg-blue-200">SignIn</button>
          </div>
        )}
        </div>
